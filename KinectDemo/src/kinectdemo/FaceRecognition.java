...
public class FaceRecognition {
  ...
  private void storeTrainingData() {
    ...
    LOGGER.info("writing files/facedata.xml");

    // create a file-storage interface
    fileStorage = cvOpenFileStorage(
            "/home/hh354/NetBeansProjects/KinectDemo/src/kinectdemo/files/facedata.xml", // filename
            null, // memstorage
    ...
    for (i = 0; i < nPersons; i++) {
      ...
      cvWriteString(
              fileStorage, // fs
              varname, // name
              personNames.get(i).toString(), // string
              0); // quote
    }
  ...
  private CvMat loadTrainingData() {
    ...
    fileStorage = cvOpenFileStorage(
            ...
            null); // encoding
    if (fileStorage == null) {
      LOGGER.error("Can't open training database file 'files/facedata.xml'.");
      return null;
    }
    ...
    nPersons = cvReadIntByName(
            ...
            0); // default_value
    if (nPersons == 0) {
      LOGGER.error("No people found in the training database 'files/facedata.xml'.");
      return null;
    } else {
  ...
  private void storeEigenfaceImages() {
    ...
    LOGGER.info("Saving the image of the average face as 'files/out_averageImage.bmp'");
    cvSaveImage("/home/hh354/NetBeansProjects/KinectDemo/src/kinectdemo/files/out_averageImage.bmp", pAvgTrainImg);

    // Create a large image made of many eigenface images.
    // Must also convert each eigenface image to a normal 8-bit UCHAR image instead of a 32-bit float image.
    LOGGER.info("Saving the " + nEigens + " eigenvector images as 'files/out_eigenfaces.bmp'");
    ...
    if (nEigens > 0) {
      ...
      cvSaveImage(
              "/home/hh354/NetBeansProjects/KinectDemo/src/kinectdemo/files/out_eigenfaces.bmp", // filename
              bigImg); // image
...
//          }
  ...
  public static void main(final String[] args) {
    ...
    faceRecognition.learn("/home/hh354/NetBeansProjects/KinectDemo/src/kinectdemo/files/all10.txt");
    //faceRecognition.recognizeFileList("data/some-test-faces.txt");
    faceRecognition.recognizeFileList("/home/hh354/NetBeansProjects/KinectDemo/src/kinectdemo/files/lower3.txt");
  }
}